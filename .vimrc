...
autocmd FileType c       map <buffer> <F9>  :wa <C-v><C-j> !gcc -Wall -Wextra -Wpedantic -Wdouble-promotion -Wformat -Wformat-nonliteral -Wformat-security -Wformat-y2k -Wmissing-include-dirs -Wswitch-enum -Wuninitialized -Wcast-qual -Wcast-align -Wlogical-op -Winline -Winvalid-pch -o %:p:r % <C-v><C-j> !%:p:r <CR><CR>
autocmd FileType c       map <buffer> <F10> :wa <C-v><C-j> !gcc -Wall -Wextra -Wpedantic -Wdouble-promotion -Wformat -Wformat-nonliteral -Wformat-security -Wformat-y2k -Wmissing-include-dirs -Wswitch-enum -Wuninitialized -Wcast-qual -Wcast-align -Wlogical-op -Winline -Winvalid-pch -o %:p:r % <CR>
