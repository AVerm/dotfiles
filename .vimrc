...
autocmd FileType cpp     map <buffer> <F9>  :wa <C-v><C-j> !g++ -std=c++14 -Wall -Wextra -Wpedantic -Wdouble-promotion -Wformat-nonliteral -Wformat-security -Wformat-y2k -Wformat-signedness -Wmissing-include-dirs -Wuninitialized -Wcast-qual -Wcast-align -Wzero-as-null-pointer-constant -Wdate-time -Wlogical-op -Winline -Winvalid-pch -o %:p:r % <C-v><C-j> !%:p:r <CR><CR>
autocmd FileType cpp     map <buffer> <F10> :wa <C-v><C-j> !g++ -std=c++14 -Wall -Wextra -Wpedantic -Wdouble-promotion -Wformat-nonliteral -Wformat-security -Wformat-y2k -Wformat-signedness -Wmissing-include-dirs -Wuninitialized -Wcast-qual -Wcast-align -Wzero-as-null-pointer-constant -Wdate-time -Wlogical-op -Winline -Winvalid-pch -o %:p:r % <CR><CR>
